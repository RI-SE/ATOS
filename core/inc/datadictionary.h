...
enum DataDictionaryParameter {
	DD_SCENARIO_NAME = CONFIGURATION_PARAMETER_SCENARIO_NAME,
	DD_ORIGIN_LATITUDE = CONFIGURATION_PARAMETER_ORIGIN_LATITUDE,
	DD_ORIGIN_LONGITUDE = CONFIGURATION_PARAMETER_ORIGIN_LONGITUDE,
	DD_ORIGIN_ALTITUDE = CONFIGURATION_PARAMETER_ORIGIN_ALTITUDE,
	DD_VISUALIZATION_SERVER_NAME = CONFIGURATION_PARAMETER_VISUALIZATION_SERVER_NAME,
	DD_FORCE_OBJECT_TO_LOCALHOST = CONFIGURATION_PARAMETER_FORCE_OBJECT_TO_LOCALHOST,
	DD_ASP_MAX_TIME_DIFF = CONFIGURATION_PARAMETER_ASP_MAX_TIME_DIFF,
	DD_ASP_MAX_TRAJ_DIFF = CONFIGURATION_PARAMETER_ASP_MAX_TRAJ_DIFF,
	DD_ASP_STEP_BACK_COUNT = CONFIGURATION_PARAMETER_ASP_STEP_BACK_COUNT,
	DD_ASP_FILTER_LEVEL = CONFIGURATION_PARAMETER_ASP_FILTER_LEVEL,
	DD_ASP_MAX_DELTA_TIME = CONFIGURATION_PARAMETER_ASP_MAX_DELTA_TIME,
	DD_TIME_SERVER_IP = CONFIGURATION_PARAMETER_TIME_SERVER_IP,
	DD_TIME_SERVER_PORT = CONFIGURATION_PARAMETER_TIME_SERVER_PORT,
	DD_SIMULATOR_IP = CONFIGURATION_PARAMETER_SIMULATOR_IP,
	DD_SIMULATOR_PORT_TCP = CONFIGURATION_PARAMETER_SIMULATOR_PORT_TCP,
	DD_SIMULATOR_PORT_UDP = CONFIGURATION_PARAMETER_SIMULATOR_PORT_UDP,
	DD_SIMULATOR_MODE = CONFIGURATION_PARAMETER_SIMULATOR_MODE,
	DD_VOIL_RECEIVERS = CONFIGURATION_PARAMETER_VOIL_RECEIVERS,
	DD_DTM_RECEIVERS = CONFIGURATION_PARAMETER_DTM_RECEIVERS,
	DD_EXTERNAL_SUPERVISOR_IP = CONFIGURATION_PARAMETER_EXTERNAL_SUPERVISOR_IP,
	DD_EXTERNAL_SUPERVISOR_PORT_TCP = CONFIGURATION_PARAMETER_EXTERNAL_SUPERVISOR_PORT_TCP,
	DD_RVSS_CONFIG = CONFIGURATION_PARAMETER_RVSS_CONFIG,
	DD_RVSS_RATE = CONFIGURATION_PARAMETER_RVSS_RATE,
	DD_MAX_PACKETS_LOST = CONFIGURATION_PARAMETER_MAX_PACKETS_LOST,
	DD_MISC_DATA = CONFIGURATION_PARAMETER_MISC_DATA,
