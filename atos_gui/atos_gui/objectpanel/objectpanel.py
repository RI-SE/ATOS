...
class ObjectPanelNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.set_ip_client = self.create_client(
            SetObjectIp, SetObjectIp.Request.SERVICE_NAME
        )
    ...
    def get_object_ids(self):
        ...
        future.add_done_callback(
            lambda future: self.get_object_ips(future.result().ids)
        )
    ...
    def get_object_ips(self, object_ids):
        ...
        for object_id in object_ids:
            ...
            future.add_done_callback(
                lambda future: self.save_ips_locally(future.result())
            )
    ...
    def update_object_ip(self, object_id, object_ip):
        ...
        future.add_done_callback(
            lambda future: self.update_object_ip_result(future.result())
        )
