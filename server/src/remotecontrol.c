...
U32 RemoteControlSendServerStatus(I32 ServerSocketI32, ServiceSessionType * SessionData, U32 StatusU32,
								  U8 Debug) {
	...
	LengthC8[0] = (C8) (LengthU32 >> 24);
	LengthC8[1] = (C8) (LengthU32 >> 16);
	LengthC8[2] = (C8) (LengthU32 >> 8);
	LengthC8[3] = (C8) (LengthU32);
	...
	if (ClientResultI32 > 0) {
		if (Debug) {
			...
			for (i = 0; i < ClientResultI32; i++)
				printf("%d-", FirstResponseC8[i]);
			printf("\n");
		}
	}
...
U32 RemoteControlSignIn(I32 ServerSocketI32, C8 * TablenameC8, C8 * UsernameC8, C8 * PasswordC8,
						ServiceSessionType * SessionData, U8 Debug) {
