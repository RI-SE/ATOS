...
mondeo_O1_point = xosc.LanePosition(14.25, 0, 1, 0) # Center line of crossing road
mondeo_trigger_positions = {
	CAMERA_DRONE_ID: xosc.LanePosition(30.0, 0, 1, 0),
	UFO_ID: xosc.LanePosition(30.0, 0, 1, 0),
	VIRTUAL_ID: xosc.LanePosition(30.0, 0, 1, 0),
    CARRIER_ID: xosc.LanePosition(30.0, 0, 1, 0),
    MARKER_DRONE_ID: xosc.LanePosition(30.0, 0, 1, 0)
}
mondeo_slow_down_position = xosc.LanePosition(30.0, 0, 1, 0) # First light pole
mondeo_accelerate_position = xosc.LanePosition(58.3, 0, 1, 0) # Second light pole
mondeo_brake_position = xosc.LanePosition(82.0, 0, 1, 0) # Third light pole

# ufo
ufo_speed = 10 / 3.6 # m/s
ufo_acceleration = 1.38 # m/s^2
ufo_retardation = 1.83 # m/s^2
ufo_O2_point = xosc.LanePosition(14.25, 2.50, -1, 0)
ufo_brake_position = xosc.LanePosition(48.3, 2.50, -1, 0)

# carrier
carrier_speed = 15 / 3.6 # m/s
carrier_acceleration = 1.12 # m/s^2
carrier_retardation = 1.03 # m/s^2
carrier_O3_point = xosc.LanePosition(58.3, 0,-1, 0)
carrier_brake_position = xosc.LanePosition(82.0, 0,-1, 0)

# virtual object
virtual_speed = 30 / 3.6 # m/s
virtual_acceleration = 3.53 # m/s^2
virtual_retardation = 10.32 # m/s^2
virtual_O4_point = xosc.LanePosition(82.0, 0, 1, 0)
virtual_brake_position = xosc.LanePosition(30.0, 0, 1, 0)
virtual_trigger_delay = 3

# camera drone
camera_drone_speed = ufo_speed # 15 / 3.6 # m/s
camera_drone_acceleration = ufo_acceleration # 1.76 # m/s^2
camera_drone_retardation = ufo_retardation # 1.96 # m/s^2
camera_drone_O5_point = ufo_O2_point
camera_drone_brake_position = ufo_brake_position
