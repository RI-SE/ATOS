...
protected:
	...
	void newMqtt2RosBridge(const std::shared_ptr<atos_interfaces::srv::NewMqtt2RosBridge::Request> request,
						   std::shared_ptr<atos_interfaces::srv::NewMqtt2RosBridge::Response> response);

	void newRos2MqttBridge(const std::shared_ptr<atos_interfaces::srv::NewRos2MqttBridge::Request> request,
						   std::shared_ptr<atos_interfaces::srv::NewRos2MqttBridge::Response> response);
...
private:
	 ...
	 */
	rclcpp::Service<atos_interfaces::srv::NewMqtt2RosBridge>::SharedPtr new_mqtt2ros_bridge_service_;

	/** @brief ROS Service server for providing dynamic ROS to MQTT mappings.
	 */
	rclcpp::Service<atos_interfaces::srv::NewRos2MqttBridge>::SharedPtr new_ros2mqtt_bridge_service_;
	...
	void onCustomCommandActionMsg(const ROSChannels::CustomCommandAction::message_type::SharedPtr);
