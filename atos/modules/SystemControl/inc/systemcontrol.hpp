...
private:
	...
	typedef enum {
		...
		ConnectObject_0,
		DisconnectObject_0,
		GetServerParameterList_0,
		SetServerParameter_2,
		GetServerParameter_1,
		DownloadFile_1,
		UploadFile_4,
		CheckFileDirectoryExist_1,
		GetRootDirectoryContent_0,
	...
	typedef enum { MSCP_BACK_TO_START = 3 } MSCPRemoteControlCommand;
	...
	void SystemControlSendControlResponse(U16 ResponseStatus,
										  const char* ResponseString,
										  const char* ResponseData,
										  I32 ResponseDataLength,
										  I32* Sockfd,
										  U8 Debug);
	I32 SystemControlBuildControlResponse(U16 ResponseStatus,
										  char* ResponseString,
										  char* ResponseData,
										  I32 ResponseDataLength,
										  U8 Debug);
	void SystemControlFileDownloadResponse(U16 ResponseStatus,
										   const char* ResponseString,
										   I32 ResponseDataLength,
										   I32* Sockfd,
										   U8 Debug);
	...
	void SystemControlCreateProcessChannel(const char* name, const U32 port, I32* sockfd, struct sockaddr_in* addr);
	...
	I32 SystemControlGetServerParameter(char* ParameterName, char* ReturnValue, U32 BufferLength, U8 Debug);
	...
	I32 SystemControlUploadFile(const char* Filename,
								const char* FileSize,
	...
	I32 SystemControlSendFileContent(I32* sockfd,
									 const char* Path,
									 const char* PacketSize,
									 char* ReturnValue,
									 U8 Remove,
	...
	I32 SystemControlBuildRVSSTimeChannelMessage(char* RVSSData, U32* RVSSDataLengthU32, U8 Debug);
	I32 SystemControlBuildRVSSATOSChannelMessage(char* RVSSData, U32* RVSSDataLengthU32, U8 SysCtrlState, U8 Debug);
	...
	/* variables */
	const char* SystemControlStatesArr[7] = {"UNDEFINED", "INITIALIZED", "IDLE", "READY", "RUNNING", "INWORK", "ERROR"};
	...
	const char* SystemControlCommandsArr[37]   = {"Idle_0",
												  "GetServerStatus_0",
												  "ArmScenario_0",
												  "DisarmScenario_0",
												  "StartScenario_1",
