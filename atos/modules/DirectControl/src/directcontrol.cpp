...
void DirectControl::handleISOMessage(std::vector<char>& byteData, size_t receivedBytes) {
...
size_t DirectControl::handleRDCAMessage(std::vector<char>& byteData) {
...
size_t DirectControl::handleUnknownMessage(std::vector<char>& byteData) {
