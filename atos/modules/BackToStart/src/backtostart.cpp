...
BackToStart::BackToStart() :
  Module(BackToStart::moduleName) {
	getObjectReturnTrajectoryService = create_service<atos_interfaces::srv::GetObjectReturnTrajectory>(
	  ServiceNames::getObjectReturnTrajectory, std::bind(&BackToStart::onReturnTrajectoryRequest, this, _1, _2));
 ...
 */
void BackToStart::onReturnTrajectoryRequest(
  const std::shared_ptr<atos_interfaces::srv::GetObjectReturnTrajectory::Request> request,
  std::shared_ptr<atos_interfaces::srv::GetObjectReturnTrajectory::Response> response) {
	...
	// Add first turn
	ATOS::Trajectory turn1 =
	  ATOS::Trajectory::createWilliamsonTurn(turnRadius, 1, minSpeed, maxSpeed, currentTraj.points.back());
	...
	// Add last turn
	ATOS::Trajectory turn2 =
	  ATOS::Trajectory::createWilliamsonTurn(turnRadius, 1, minSpeed, maxSpeed, b2sTraj.points.back());
	...
	RCLCPP_INFO(get_logger(),
				"Calculated return trajectory for object %u with %lu points",
				response->id,
