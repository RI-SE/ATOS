...
void OsiHandler::decodeSdMessage(const std::vector<char>& msg, const int msgSize, const bool debug) {
...
void OsiHandler::decodeSvGtMessage(const std::vector<char>& msg,
								   const int msgSize,
...
std::string OsiHandler::encodeSvGtMessage(const std::vector<LocalObjectGroundTruth_t>& data,
...
std::string OsiHandler::encodeSvGtMessage(const std::vector<GlobalObjectGroundTruth_t>& data,
										  const std::chrono::system_clock::time_point& timestamp,
										  const std::string& projectionString,
										  const bool debug) {
...
std::string OsiHandler::encodeSvGtMessage(const LocalObjectGroundTruth_t& data,
										  const std::chrono::system_clock::time_point& timestamp,
										  const std::string& projectionString,
										  const bool debug) {
...
std::string OsiHandler::encodeSvGtMessage(const GlobalObjectGroundTruth_t& data,
										  const std::chrono::system_clock::time_point& timestamp,
										  const std::string& projectionString,
										  const bool debug) {
